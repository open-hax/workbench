...
var cfg = (function (){var or__5002__auto__ = (function (){var G__11316 = window;
var G__11316__$1 = (((G__11316 == null))?null:(G__11316["__WORKBENCH_BACKENDS__"]));
if((G__11316__$1 == null)){
return null;
} else {
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(G__11316__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
}
})();
...
var map__11320 = opencode_unified.openplanner.runtime_config();
var map__11320__$1 = cljs.core.__destructure_map(map__11320);
var endpoint = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11320__$1,new cljs.core.Keyword(null,"endpoint","endpoint",447890044));
var api_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11320__$1,new cljs.core.Keyword(null,"api-key","api-key",1037904031));
var headers = (function (){var G__11321 = new cljs.core.PersistentArrayMap(null, 1, ["Content-Type","application/json"], null);
if((!((api_key == null)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11321,"Authorization",["Bearer ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(api_key)].join(''));
} else {
return G__11321;
}
})();
...
})).then((function (p1__11317_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__11317_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
}));
}));
