...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__9543){
var map__9544 = p__9543;
var map__9544__$1 = cljs.core.__destructure_map(map__9544);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9544__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__9552 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__9553 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__9553);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__9552);
}}));
} else {
...
(jsprops.onChange = (function (p1__9567_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__9567_SHARP_);
}));
