...
var G__9584 = o;
reagent.impl.template.goog$module$goog$object.set(G__9584,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__9641__i < G__9641__a.length) {G__9641__a[G__9641__i] = arguments[G__9641__i + 0]; ++G__9641__i;}
  args = new cljs.core.IndexedSeq(G__9641__a,0,null);
} 
return G__9636__delegate.call(this,args);};
G__9636.cljs$lang$maxFixedArity = 0;
G__9636.cljs$lang$applyTo = (function (arglist__9642){
var args = cljs.core.seq(arglist__9642);
...
var G__9586 = o;
reagent.impl.template.goog$module$goog$object.set(G__9586,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__9648__i < G__9648__a.length) {G__9648__a[G__9648__i] = arguments[G__9648__i + 0]; ++G__9648__i;}
  args = new cljs.core.IndexedSeq(G__9648__a,0,null);
} 
...
var G__9592 = props;
var G__9592__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9592,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9592);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9592__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__9594 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__9594,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__9594;
}
})(),id_class);
...
var G__9595 = (cljs.core.count(argv) - first_child);
switch (G__9595) {
case (0):
...
var vec__9598 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9598,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9598,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9598,(2),null);
...
var temp__5808__auto___9656 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___9656 == null)){
} else {
var key_9657 = temp__5808__auto___9656;
(jsprops.key = key_9657);
}
...
var temp__5808__auto___9658 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___9658 == null)){
} else {
var key_9659 = temp__5808__auto___9658;
(jsprops.key = key_9659);
}
...
var temp__5808__auto___9660 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___9660 == null)){
} else {
var key_9661 = temp__5808__auto___9660;
(jsprops.key = key_9661);
}
...
var temp__5808__auto___9662 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___9662 == null)){
} else {
var key_9663 = temp__5808__auto___9662;
(jsprops.key = key_9663);
}
...
var temp__5808__auto___9671 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___9671 == null)){
} else {
var key_9672 = temp__5808__auto___9671;
(jsprops.key = key_9672);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9605_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__9605_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__9607 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9607,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9607,(1),null);
...
break;
default:
var G__9676 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__9677 = compiler;
v = G__9676;
compiler = G__9677;
continue;
...
var G__9615 = tag;
var G__9615__$1 = (((G__9615 instanceof cljs.core.Keyword))?G__9615.fqn:null);
switch (G__9615__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template9622 = (function (opts,id,fn_to_element,parse_fn,meta9623){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template9622.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_9624,meta9623__$1){
var self__ = this;
var _9624__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template9622(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta9623__$1));
}));

(reagent.impl.template.t_reagent$impl$template9622.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_9624){
var self__ = this;
var _9624__$1 = this;
return self__.meta9623;
}));

(reagent.impl.template.t_reagent$impl$template9622.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template9622.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template9622.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template9622.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template9622.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template9622.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta9623","meta9623",-321080070,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template9622.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template9622.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template9622");

(reagent.impl.template.t_reagent$impl$template9622.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template9622");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template9622.
 */
reagent.impl.template.__GT_t_reagent$impl$template9622 = (function reagent$impl$template$__GT_t_reagent$impl$template9622(opts,id,fn_to_element,parse_fn,meta9623){
return (new reagent.impl.template.t_reagent$impl$template9622(opts,id,fn_to_element,parse_fn,meta9623));
});
...
return (new reagent.impl.template.t_reagent$impl$template9622(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
