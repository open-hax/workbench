...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(opencode_unified.state.app_state,cljs.core.update,new cljs.core.Keyword(null,"ui","ui",-469653645),(function (p1__11364_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"command-palette","command-palette",153522288),opencode_unified.command_palette.default_palette_state], null),p1__11364_SHARP_], 0));
}));
});
...
args__5732__auto__.push((arguments[i__5727__auto___11445]));
...
/** @this {Function} */
(opencode_unified.command_palette.update_palette_BANG_.cljs$lang$applyTo = (function (seq11368){
var G__11369 = cljs.core.first(seq11368);
var seq11368__$1 = cljs.core.next(seq11368);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11369,seq11368__$1);
}));
...
opencode_unified.command_palette.normalize_command = (function opencode_unified$command_palette$normalize_command(p__11416){
var map__11417 = p__11416;
var map__11417__$1 = cljs.core.__destructure_map(map__11417);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11417__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11417__$1,new cljs.core.Keyword(null,"title","title",636505583));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11417__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11417__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var destructive_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11417__$1,new cljs.core.Keyword(null,"destructive?","destructive?",1136140718));
var confirm_message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11417__$1,new cljs.core.Keyword(null,"confirm-message","confirm-message",1667051556));
var keywords = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11417__$1,new cljs.core.Keyword(null,"keywords","keywords",1526959054));
...
var seq__11419 = cljs.core.seq(commands);
var chunk__11420 = null;
var count__11421 = (0);
var i__11422 = (0);
while(true){
if((i__11422 < count__11421)){
var command = chunk__11420.cljs$core$IIndexed$_nth$arity$2(null,i__11422);
opencode_unified.command_palette.register_command_BANG_(command);


var G__11453 = seq__11419;
var G__11454 = chunk__11420;
var G__11455 = count__11421;
var G__11456 = (i__11422 + (1));
seq__11419 = G__11453;
chunk__11420 = G__11454;
count__11421 = G__11455;
i__11422 = G__11456;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__11419);
if(temp__5804__auto__){
var seq__11419__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__11419__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__11419__$1);
var G__11457 = cljs.core.chunk_rest(seq__11419__$1);
var G__11458 = c__5525__auto__;
var G__11459 = cljs.core.count(c__5525__auto__);
var G__11460 = (0);
seq__11419 = G__11457;
chunk__11420 = G__11458;
count__11421 = G__11459;
i__11422 = G__11460;
continue;
} else {
var command = cljs.core.first(seq__11419__$1);
opencode_unified.command_palette.register_command_BANG_(command);


var G__11461 = cljs.core.next(seq__11419__$1);
var G__11462 = null;
var G__11463 = (0);
var G__11464 = (0);
seq__11419 = G__11461;
chunk__11420 = G__11462;
count__11421 = G__11463;
i__11422 = G__11464;
continue;
}
} else {
...
opencode_unified.command_palette.command_haystack = (function opencode_unified$command_palette$command_haystack(p__11423){
var map__11424 = p__11423;
var map__11424__$1 = cljs.core.__destructure_map(map__11424);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11424__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11424__$1,new cljs.core.Keyword(null,"title","title",636505583));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11424__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var keywords = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11424__$1,new cljs.core.Keyword(null,"keywords","keywords",1526959054));
...
var map__11426 = opencode_unified.command_palette.palette_state();
var map__11426__$1 = cljs.core.__destructure_map(map__11426);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11426__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
...
return cljs.core.vec(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__11425_SHARP_){
return clojure.string.includes_QMARK_(opencode_unified.command_palette.command_haystack(p1__11425_SHARP_),needle);
}),commands));
}
});
...
try{var result = (function (){var fexpr__11428 = new cljs.core.Keyword(null,"handler","handler",-195596612).cljs$core$IFn$_invoke$arity$1(command);
return (fexpr__11428.cljs$core$IFn$_invoke$arity$0 ? fexpr__11428.cljs$core$IFn$_invoke$arity$0() : fexpr__11428.call(null));
})();
...
var map__11429 = opencode_unified.command_palette.palette_state();
var map__11429__$1 = cljs.core.__destructure_map(map__11429);
var selected_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11429__$1,new cljs.core.Keyword(null,"selected-index","selected-index",1735686526));
...
var temp__5804__auto___11473 = (function (){var G__11431 = window;
if((G__11431 == null)){
return null;
} else {
return (G__11431["localStorage"]);
}
})();
if(cljs.core.truth_(temp__5804__auto___11473)){
var storage_11474 = temp__5804__auto___11473;
storage_11474.setItem("opencode.workbench.last-save",(new Date()).toISOString());
} else {
}
...
});})(i__11436,vec__11438,index,command,c__5478__auto__,size__5479__auto__,b__11437,s__11435__$2,temp__5804__auto__,map__11433,map__11433__$1,visible_QMARK_,query,selected_index,feedback,pending_confirmation,commands))
,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__11436,vec__11438,index,command,c__5478__auto__,size__5479__auto__,b__11437,s__11435__$2,temp__5804__auto__,map__11433,map__11433__$1,visible_QMARK_,query,selected_index,feedback,pending_confirmation,commands){
return (function (){
return opencode_unified.command_palette.execute_BANG_(command);
});})(i__11436,vec__11438,index,command,c__5478__auto__,size__5479__auto__,b__11437,s__11435__$2,temp__5804__auto__,map__11433,map__11433__$1,visible_QMARK_,query,selected_index,feedback,pending_confirmation,commands))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__11437),opencode_unified$command_palette$command_palette_$_iter__11434(cljs.core.chunk_rest(s__11435__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__11437),null);
}
} else {
var vec__11441 = cljs.core.first(s__11435__$2);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11441,(0),null);
var command = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11441,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.command-item","button.command-item",-1911176088),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"data-testid","data-testid",102116723),"command-palette-item",new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(selected_index,index))?"selected":null),new cljs.core.Keyword(null,"on-mouse-enter","on-mouse-enter",-1664921661),((function (vec__11441,index,command,s__11435__$2,temp__5804__auto__,map__11433,map__11433__$1,visible_QMARK_,query,selected_index,feedback,pending_confirmation,commands){
return (function (){
return opencode_unified.command_palette.update_palette_BANG_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.assoc,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"selected-index","selected-index",1735686526),index], 0));
});})(vec__11441,index,command,s__11435__$2,temp__5804__auto__,map__11433,map__11433__$1,visible_QMARK_,query,selected_index,feedback,pending_confirmation,commands))
,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__11441,index,command,s__11435__$2,temp__5804__auto__,map__11433,map__11433__$1,visible_QMARK_,query,selected_index,feedback,pending_confirmation,commands){
return (function (){
return opencode_unified.command_palette.execute_BANG_(command);
});})(vec__11441,index,command,s__11435__$2,temp__5804__auto__,map__11433,map__11433__$1,visible_QMARK_,query,selected_index,feedback,pending_confirmation,commands))
,new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"align-items","align-items",-267946462),new cljs.core.Keyword(null,"text-align","text-align",1786091845),new cljs.core.Keyword(null,"width","width",-384071477),new cljs.core.Keyword(null,"background","background",-863952629),new cljs.core.Keyword(null,"cursor","cursor",1011937484),new cljs.core.Keyword(null,"border-left","border-left",-1150760178),new cljs.core.Keyword(null,"padding","padding",1660304693),new cljs.core.Keyword(null,"justify-content","justify-content",-1990475787),new cljs.core.Keyword(null,"gap","gap",80255254),new cljs.core.Keyword(null,"display","display",242065432),new cljs.core.Keyword(null,"border","border",1444987323)],["center","left","100%",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(selected_index,index))?"var(--bg-selection)":"transparent"),"pointer",((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(selected_index,index))?"2px solid var(--accent)":"2px solid transparent"),"0.58rem 0.65rem","space-between","0.5rem","flex","none"])], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"color","color",1011675173),"var(--text-primary)",new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"0.83rem",new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),"600"], null)], null),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(command)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"color","color",1011675173),"var(--text-secondary)",new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"0.76rem"], null)], null),new cljs.core.Keyword(null,"description","description",-1428560544).cljs$core$IFn$_invoke$arity$1(command)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"0.72rem",new cljs.core.Keyword(null,"color","color",1011675173),(cljs.core.truth_(new cljs.core.Keyword(null,"destructive?","destructive?",1136140718).cljs$core$IFn$_invoke$arity$1(command))?"var(--error)":"var(--text-dim)")], null)], null),(cljs.core.truth_(new cljs.core.Keyword(null,"destructive?","destructive?",1136140718).cljs$core$IFn$_invoke$arity$1(command))?"Destructive":new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(command))], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(command)], null)),opencode_unified$command_palette$command_palette_$_iter__11434(cljs.core.rest(s__11435__$2)));
}
} else {
return null;
}
