...
var ext = (function (){var G__11447 = file_path;
var G__11447__$1 = (((G__11447 == null))?null:clojure.string.split.cljs$core$IFn$_invoke$arity$2(G__11447,/\\./));
var G__11447__$2 = (((G__11447__$1 == null))?null:cljs.core.last(G__11447__$1));
if((G__11447__$2 == null)){
return null;
} else {
return clojure.string.lower_case(G__11447__$2);
}
})();
var G__11448 = ext;
switch (G__11448) {
...
return cljs.core.some((function (p__11449){
var vec__11450 = p__11449;
var buffer_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11450,(0),null);
var buffer = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11450,(1),null);
...
var len__5726__auto___11509 = arguments.length;
var i__5727__auto___11510 = (0);
while(true){
if((i__5727__auto___11510 < len__5726__auto___11509)){
args__5732__auto__.push((arguments[i__5727__auto___11510]));

var G__11511 = (i__5727__auto___11510 + (1));
i__5727__auto___11510 = G__11511;
continue;
} else {
}
break;
...
(opencode_unified.buffers.create_buffer.cljs$core$IFn$_invoke$arity$variadic = (function (file_path,content,p__11468){
...
var metadata = first__11471;
var options = seq__11470__$1;
var buffer_id = opencode_unified.buffers.generate_buffer_id();
...
/** @this {Function} */
(opencode_unified.buffers.create_buffer.cljs$lang$applyTo = (function (seq11465){
var G__11466 = cljs.core.first(seq11465);
var seq11465__$1 = cljs.core.next(seq11465);
var G__11467 = cljs.core.first(seq11465__$1);
var seq11465__$2 = cljs.core.next(seq11465__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11466,G__11467,seq11465__$2);
}));
...
var G__11515 = (current_line + (1));
var G__11516 = (pos + (cljs.core.count(cljs.core.first(remaining_lines)) + (1)));
var G__11517 = cljs.core.rest(remaining_lines);
current_line = G__11515;
pos = G__11516;
remaining_lines = G__11517;
continue;
}
break;
}
...
var current_pos = el.selectionStart;
var vec__11476 = opencode_unified.buffers.pos_to_line_col(content,current_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11476,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11476,(1),null);
if((line > (0))){
...
var content = el.value;
var current_pos = el.selectionStart;
var vec__11479 = opencode_unified.buffers.pos_to_line_col(content,current_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11479,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11479,(1),null);
...
var content = el.value;
var current_pos = el.selectionStart;
var vec__11482 = opencode_unified.buffers.pos_to_line_col(content,current_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11482,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11482,(1),null);
...
var content = el.value;
var current_pos = el.selectionStart;
var vec__11485 = opencode_unified.buffers.pos_to_line_col(content,current_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11485,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11485,(1),null);
...
var content = el.value;
var current_pos = el.selectionStart;
var vec__11488 = opencode_unified.buffers.pos_to_line_col(content,current_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11488,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11488,(1),null);
var line_range = opencode_unified.buffers.get_line_range(content,line);
var vec__11491 = line_range;
var start_pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11491,(0),null);
var end_pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11491,(1),null);
...
var content = el.value;
var current_end = el.selectionEnd;
var vec__11494 = opencode_unified.buffers.pos_to_line_col(content,current_end);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11494,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11494,(1),null);
if((line > (0))){
var new_pos = opencode_unified.buffers.line_col_to_pos(content,(line - (1)),col);
(el.selectionEnd = new_pos);
...
var content = el.value;
var current_end = el.selectionEnd;
var vec__11497 = opencode_unified.buffers.pos_to_line_col(content,current_end);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11497,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11497,(1),null);
var line_count = opencode_unified.buffers.get_line_count(content);
if((line < (line_count - (1)))){
var new_pos = opencode_unified.buffers.line_col_to_pos(content,(line + (1)),col);
(el.selectionEnd = new_pos);
...
var cursor_pos_11523 = new cljs.core.Keyword(null,"cursor-pos","cursor-pos",-1464230440).cljs$core$IFn$_invoke$arity$1(current_buffer);
opencode_unified.state.update_current_buffer_BANG_((function (b){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(b,new cljs.core.Keyword(null,"selection","selection",975998651),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"start","start",-355208981),cursor_pos_11523,new cljs.core.Keyword(null,"end","end",-268185958),cursor_pos_11523], null));
}));
} else {
}
...
var current_buffer = opencode_unified.state.get_current_buffer();
if(cljs.core.truth_(current_buffer)){
var content_11526 = new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(current_buffer);
var cursor_pos_11527 = new cljs.core.Keyword(null,"cursor-pos","cursor-pos",-1464230440).cljs$core$IFn$_invoke$arity$1(current_buffer);
var vec__11500_11528 = opencode_unified.buffers.pos_to_line_col(content_11526,cursor_pos_11527);
var line_11529 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11500_11528,(0),null);
var __11530 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11500_11528,(1),null);
var line_range_11531 = opencode_unified.buffers.get_line_range(content_11526,line_11529);
opencode_unified.state.update_current_buffer_BANG_((function (b){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(b,new cljs.core.Keyword(null,"selection","selection",975998651),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"start","start",-355208981),cljs.core.first(line_range_11531),new cljs.core.Keyword(null,"end","end",-268185958),cljs.core.second(line_range_11531)], null));
}));
} else {
}
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__11503_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(p1__11503_SHARP_),path);
...
var G__11533 = (current_pos + (1));
current_pos = G__11533;
continue;
} else {
return current_pos;
}
...
var char$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(content,current_pos);
if(clojure.string.includes_QMARK_(word_chars,char$)){
var G__11534 = (current_pos - (1));
current_pos = G__11534;
continue;
} else {
