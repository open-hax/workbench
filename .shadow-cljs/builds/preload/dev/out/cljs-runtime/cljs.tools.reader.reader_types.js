...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_16978 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_16978(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_16997 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_16997(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_17001 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_17001(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_17009 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_17009(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_17015 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_17015(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_17019 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_17019(reader);
}
});
...
var G__17183 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__17184 = s.append(c);
c = G__17183;
s = G__17184;
continue;
}
