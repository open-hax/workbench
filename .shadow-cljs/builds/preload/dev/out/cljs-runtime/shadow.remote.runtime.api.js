...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_15937 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_15937(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_15941 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_15941(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_15944 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_15944(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_15949 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_15949(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_15971 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_15971(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_15977 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_15977(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__15920,callback){
var map__15921 = p__15920;
var map__15921__$1 = cljs.core.__destructure_map(map__15921);
var input = map__15921__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15921__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15921__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
