...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_17040 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_17040(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_17044 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_17044(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_17045 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_17045(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_17048 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_17048(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_17050 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_17050(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_17056 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_17056(reader);
}
});
...
var G__17212 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__17213 = s.append(c);
c = G__17212;
s = G__17213;
continue;
}
