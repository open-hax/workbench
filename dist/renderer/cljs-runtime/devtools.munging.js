...
var o22201 = temp__5802__auto__;
var temp__5802__auto____$1 = (o22201["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o22202 = temp__5802__auto____$1;
return (o22202["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__20542__auto___23872 = t;
(o__20542__auto___23872["cljs$lang$ctorPrWriter"]).call(o__20542__auto___23872,t,writer);
}catch (e22294){var __23873 = e22294;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22343 = num_code;
switch (G__22343) {
case (1):
return (185);
...
}catch (e22520){var _e__20586__auto__ = e22520;
return false;
}})())){
...
var vec__22522 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22522,(0),null);
...
var len__5726__auto___23925 = arguments.length;
var i__5727__auto___23926 = (0);
while(true){
if((i__5727__auto___23926 < len__5726__auto___23925)){
args__5732__auto__.push((arguments[i__5727__auto___23926]));

var G__23927 = (i__5727__auto___23926 + (1));
i__5727__auto___23926 = G__23927;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22681){
var vec__22682 = p__22681;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22682,(0),null);
...
var G__23930 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__23931 = cljs.core.butlast(remaining_tokens);
name_tokens = G__23930;
remaining_tokens = G__23931;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22639){
var G__22640 = cljs.core.first(seq22639);
var seq22639__$1 = cljs.core.next(seq22639);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22640,seq22639__$1);
}));
...
var vec__22741 = cljs.core.split_with((function (p1__22731_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__22731_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22741,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22741,(1),null);
...
var vec__22860 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22860,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22860,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__23935 = cljs.core.rest(remaining_tokens);
var G__23936 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__23935;
name_tokens = G__23936;
continue;
} else {
...
var vec__22868 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22868,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22868,(1),null);
var vec__22871 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22871,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22871,(1),null);
var vec__22874 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22874,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22874,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22874,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22874,(3),null);
...
var vec__22927 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22927,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22927,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22927,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22927,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22927,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22927,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__22977 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22977,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22977,(1),null);
var vec__22983 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22983,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22983,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__23038 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__23038) : devtools.munging.parse_fn_info_deep.call(null,G__23038));
})()));
}
} else {
return fn_info;
...
var G__24008 = (arity + (1));
var G__24009 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23115){
var vec__23116 = p__23115;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23116,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23116,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23172_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__23172_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23173_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__23173_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___24013 = arguments.length;
var i__5727__auto___24014 = (0);
while(true){
if((i__5727__auto___24014 < len__5726__auto___24013)){
args__5732__auto__.push((arguments[i__5727__auto___24014]));

var G__24015 = (i__5727__auto___24014 + (1));
i__5727__auto___24014 = G__24015;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23270){
var vec__23271 = p__23270;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23271,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23242){
var G__23246 = cljs.core.first(seq23242);
var seq23242__$1 = cljs.core.next(seq23242);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23246,seq23242__$1);
}));
...
var map__23387 = options;
var map__23387__$1 = cljs.core.__destructure_map(map__23387);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23387__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23387__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23387__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23387__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23388 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23388,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23388,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23388,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23388,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23388,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23388,(5),null);
...
}catch (e23416){var _e__20586__auto__ = e23416;
...
var G__24043 = (obj[cljs.core.first(path)]);
var G__24044 = cljs.core.rest(path);
obj = G__24043;
path = G__24044;
continue;
} else {
...
var _STAR_ = (function (accum,p__23757){
var vec__23758 = p__23757;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23758,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23758,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23791){
var vec__23792 = p__23791;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23792,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23792,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23792,(2),null);
...
var post_process = (function (p__23818){
var vec__23820 = p__23818;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23820,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23820,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23807_SHARP_){
return (obj[cljs.core.first(p1__23807_SHARP_)]);
}),sorted_matches);
