...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31697 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_31697(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_31699 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_31699(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_31701 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_31701(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_31702 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_31702(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31707 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31707(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31709 = (function (runtime,code,success,fail){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31709(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__31688,callback){
var map__31689 = p__31688;
var map__31689__$1 = cljs.core.__destructure_map(map__31689);
var input = map__31689__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31689__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31689__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
