...
var len__5726__auto___24379 = arguments.length;
var i__5727__auto___24380 = (0);
while(true){
if((i__5727__auto___24380 < len__5726__auto___24379)){
args__5732__auto__.push((arguments[i__5727__auto___24380]));

var G__24381 = (i__5727__auto___24380 + (1));
i__5727__auto___24380 = G__24381;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq24137){
var G__24148 = cljs.core.first(seq24137);
var seq24137__$1 = cljs.core.next(seq24137);
var G__24149 = cljs.core.first(seq24137__$1);
var seq24137__$2 = cljs.core.next(seq24137__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24148,G__24149,seq24137__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__24239_SHARP_){
return (!((cljs.core.meta(p1__24239_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24299__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e24315){var _e__20586__auto__ = e24315;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e24318){var _e__20586__auto__ = e24318;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__24334 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__24335 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__24335);
...
var map__24336 = opts;
var map__24336__$1 = cljs.core.__destructure_map(map__24336);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24336__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__24334);
}});
...
var temp__5802__auto___24435 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___24435)){
var managed_print_level_24436 = temp__5802__auto___24435;
var _STAR_print_level_STAR__orig_val__24346_24437 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__24347_24438 = managed_print_level_24436;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__24347_24438);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__24343_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__24343_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__24346_24437);
}} else {
job_fn();
}
