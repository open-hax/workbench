...
}catch (e32719){var _e__20586__auto__ = e32719;
return false;
...
}catch (e32768){var _e__20586__auto__ = e32768;
return false;
...
}catch (e32783){var _e__20586__auto__ = e32783;
return false;
...
}catch (e32787){var _e__20586__auto__ = e32787;
return false;
...
}catch (e32791){var _e__20586__auto__ = e32791;
return false;
}})())){
...
}catch (e32794){var _e__20586__auto__ = e32794;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__32796 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32797 = (function (){var or__5002__auto__ = config;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32797);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32796);
}});
});
...
return (function() { 
var G__32885__delegate = function (args){
...
while (G__32886__i < G__32886__a.length) {G__32886__a[G__32886__i] = arguments[G__32886__i + 0]; ++G__32886__i;}
  args = new cljs.core.IndexedSeq(G__32886__a,0,null);
} 
return G__32885__delegate.call(this,args);};
G__32885.cljs$lang$maxFixedArity = 0;
G__32885.cljs$lang$applyTo = (function (arglist__32887){
var args = cljs.core.seq(arglist__32887);
return G__32885__delegate(args);
});
