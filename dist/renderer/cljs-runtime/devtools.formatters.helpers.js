...
var G__24096 = devtools.prefs.pref(v);
v = G__24096;
continue;
} else {
return v;
...
}catch (e23972){var _e__20586__auto__ = e23972;
return false;
}})();
...
}catch (e23975){var _e__20586__auto__ = e23975;
return false;
}})();
...
}catch (e23979){var _e__20586__auto__ = e23979;
return false;
}}
}
});
...
var vec__24050 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24050,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24050,(1),null);
...
return cljs.core.some((function (p1__24055_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24055_SHARP_);
}),template);
});
