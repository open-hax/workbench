...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_6707 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_6707(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_6714 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_6714(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6726 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6726(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6750 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6750(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6763 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6763(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6774 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6774(reader);
}
});
...
var G__6929 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__6930 = s.append(c);
c = G__6929;
s = G__6930;
continue;
}
