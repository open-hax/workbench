...
var mode_name = (function (){var G__19340 = mode;
...
var vec__19343 = opencode_unified.buffers.pos_to_line_col(content,cursor_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19343,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19343,(1),null);
...
var current_buffer_19582 = opencode_unified.state.get_current_buffer();
if(cljs.core.truth_(current_buffer_19582)){
opencode_unified.state.update_current_buffer_BANG_((function (buffer){
...
var current_buffer_19583 = opencode_unified.state.get_current_buffer();
if(cljs.core.truth_(current_buffer_19583)){
var content_19584 = new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(current_buffer_19583);
var cursor_pos_19585 = new cljs.core.Keyword(null,"cursor-pos","cursor-pos",-1464230440).cljs$core$IFn$_invoke$arity$1(current_buffer_19583);
var vec__19351_19586 = opencode_unified.buffers.pos_to_line_col(content_19584,cursor_pos_19585);
var line_19587 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19351_19586,(0),null);
var __19588 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19351_19586,(1),null);
var line_range_19589 = opencode_unified.buffers.get_line_range(content_19584,line_19587);
opencode_unified.state.update_current_buffer_BANG_((function (buffer){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(buffer,new cljs.core.Keyword(null,"selection","selection",975998651),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"start","start",-355208981),cljs.core.first(line_range_19589),new cljs.core.Keyword(null,"end","end",-268185958),cljs.core.second(line_range_19589)], null));
}));
} else {
}
...
var G__19595 = (i + (1));
var G__19596 = ((seen_QMARK_) || (opencode_unified.evil.wordch_QMARK_(s.charAt(i))));
i = G__19595;
seen_QMARK_ = G__19596;
continue;
...
var G__19597 = (i - (1));
var G__19598 = ((seen_QMARK_) || (opencode_unified.evil.wordch_QMARK_(s.charAt(i))));
i = G__19597;
seen_QMARK_ = G__19598;
continue;
...
var G__19600 = (i + (1));
var G__19601 = ((in_QMARK_) || (opencode_unified.evil.wordch_QMARK_(s.charAt(i))));
i = G__19600;
in_QMARK_ = G__19601;
continue;
...
var map__19431 = cljs.core.deref(opencode_unified.evil.reg_STAR_);
var map__19431__$1 = cljs.core.__destructure_map(map__19431);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19431__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var linewise_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19431__$1,new cljs.core.Keyword(null,"linewise?","linewise?",973313865));
...
opencode_unified.evil.apply_op_motion_BANG_ = (function opencode_unified$evil$apply_op_motion_BANG_(el,p__19439,k){
var map__19440 = p__19439;
var map__19440__$1 = cljs.core.__destructure_map(map__19440);
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19440__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var anchor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19440__$1,new cljs.core.Keyword(null,"anchor","anchor",1549638489));
var s = el.value;
var tgt = (function (){var G__19444 = k;
switch (G__19444) {
case "y":
case "d":
case "c":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19446__$1)].join('')));
...
var s_19615 = el.value;
var a_19616 = cljs.core.deref(opencode_unified.evil.v_anchor_STAR_);
opencode_unified.evil.setrange_BANG_(el,opencode_unified.evil.line_start(s_19615,a_19616),(opencode_unified.evil.line_end(s_19615,a_19616) + (1)));
} else {
...
var vec__19503 = opencode_unified.buffers.pos_to_line_col(content,cursor_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19503,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19503,(1),null);
var line_count = (function (){var x__5087__auto__ = (1);
var y__5088__auto__ = opencode_unified.buffers.get_line_count(content);
return ((x__5087__auto__ > y__5088__auto__) ? x__5087__auto__ : y__5088__auto__);
})();
var G__19507 = direction;
...
var content = new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(buffer);
var cursor_pos = new cljs.core.Keyword(null,"cursor-pos","cursor-pos",-1464230440).cljs$core$IFn$_invoke$arity$1(buffer);
var vec__19518 = opencode_unified.buffers.pos_to_line_col(content,cursor_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19518,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19518,(1),null);
...
var content = new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(buffer);
var cursor_pos = new cljs.core.Keyword(null,"cursor-pos","cursor-pos",-1464230440).cljs$core$IFn$_invoke$arity$1(buffer);
var vec__19522 = opencode_unified.buffers.pos_to_line_col(content,cursor_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19522,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19522,(1),null);
...
return opencode_unified.state.update_current_buffer_BANG_((function (p1__19532_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__19532_SHARP_,new cljs.core.Keyword(null,"cursor-pos","cursor-pos",-1464230440),(0));
}));
});
...
var content = new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(buffer);
var cursor_pos = new cljs.core.Keyword(null,"cursor-pos","cursor-pos",-1464230440).cljs$core$IFn$_invoke$arity$1(buffer);
var vec__19540 = opencode_unified.buffers.pos_to_line_col(content,cursor_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19540,(0),null);
...
var content = new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(buffer);
var cursor_pos = new cljs.core.Keyword(null,"cursor-pos","cursor-pos",-1464230440).cljs$core$IFn$_invoke$arity$1(buffer);
var vec__19543 = opencode_unified.buffers.pos_to_line_col(content,cursor_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19543,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19543,(1),null);
...
var content = new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(buffer);
var cursor_pos = new cljs.core.Keyword(null,"cursor-pos","cursor-pos",-1464230440).cljs$core$IFn$_invoke$arity$1(buffer);
var vec__19547 = opencode_unified.buffers.pos_to_line_col(content,cursor_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19547,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19547,(1),null);
var vec__19550 = (function (){var or__5002__auto__ = opencode_unified.buffers.get_line_range(content,line);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var start_pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19550,(0),null);
var end_pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19550,(1),null);
...
var content = new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(buffer);
var cursor_pos = new cljs.core.Keyword(null,"cursor-pos","cursor-pos",-1464230440).cljs$core$IFn$_invoke$arity$1(buffer);
var vec__19553 = opencode_unified.buffers.pos_to_line_col(content,cursor_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19553,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19553,(1),null);
var vec__19556 = (function (){var or__5002__auto__ = opencode_unified.buffers.get_line_range(content,line);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),cljs.core.count(content)], null);
...
var start_pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19556,(0),null);
var end_pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19556,(1),null);
var newline_pos = (((((end_pos < cljs.core.count(content))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(content,end_pos),"\n"))))?(end_pos + (1)):end_pos);
...
var content = new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(buffer);
var cursor_pos = new cljs.core.Keyword(null,"cursor-pos","cursor-pos",-1464230440).cljs$core$IFn$_invoke$arity$1(buffer);
var vec__19560 = opencode_unified.buffers.pos_to_line_col(content,cursor_pos);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19560,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19560,(1),null);
var line_count = (function (){var x__5087__auto__ = (1);
var y__5088__auto__ = opencode_unified.buffers.get_line_count(content);
return ((x__5087__auto__ > y__5088__auto__) ? x__5087__auto__ : y__5088__auto__);
})();
var next_pos = (function (){var G__19563 = direction;
