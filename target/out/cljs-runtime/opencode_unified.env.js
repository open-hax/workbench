...
if(opencode_unified.env.electron_QMARK_()){
var temp__5802__auto__ = (function (){var G__5830 = opencode_unified.env.electron_api();
if((G__5830 == null)){
return null;
} else {
return (G__5830["getAppVersion"]);
}
})();
...
if(opencode_unified.env.electron_QMARK_()){
var temp__5802__auto__ = (function (){var G__5838 = opencode_unified.env.electron_api();
if((G__5838 == null)){
return null;
} else {
return (G__5838["openExternal"]);
}
})();
if(cljs.core.truth_(temp__5802__auto__)){
