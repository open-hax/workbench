...
var G__9328 = devtools.prefs.pref(v);
v = G__9328;
continue;
} else {
return v;
...
}catch (e9206){var _e__7968__auto__ = e9206;
return false;
}})();
...
}catch (e9211){var _e__7968__auto__ = e9211;
return false;
}})();
...
}catch (e9224){var _e__7968__auto__ = e9224;
return false;
}}
}
});
...
var vec__9268 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9268,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9268,(1),null);
...
return cljs.core.some((function (p1__9287_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9287_SHARP_);
}),template);
});
