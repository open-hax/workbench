...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_9993 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_9993(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_10001 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_10001(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_10009 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_10009(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_10013 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_10013(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_10015 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_10015(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_10016 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_10016(reader);
}
});
...
var G__10086 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__10087 = s.append(c);
c = G__10086;
s = G__10087;
continue;
}
